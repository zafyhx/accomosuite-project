...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Login Gagal. Coba cek koneksi server.');
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 pt-20 pb-10 font-sans">
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl border border-gray-100">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-secondary">Masuk Accomosuite</h2>
          <p className="text-gray-500 mt-2">Login untuk mengelola reservasi Anda</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? <><Loader2 className="animate-spin" size={20}/> Masuk...</> : 'Login Sekarang'}
          </button>
        </form>
