  ...
  if (loading)
    return (
      <div className="p-12 text-center">
        ...
        <p className="text-gray-600 mt-3">Memuat data suite...</p>
      </div>
    );
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Contoh: WiFi, AC, Pool, Breakfast"
            required
            className="w-full p-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary outline-none transition"
          />
        </div>
        ...
        >
          {isSaving ? (
            ...
            <>
              <Save size={20} />{" "}
              {isEditMode ? "Update Properti" : "Tambah Properti"}
            </>
          )}
        </button>
      </form>
