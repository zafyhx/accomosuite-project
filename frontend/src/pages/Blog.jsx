...
    if (!path) return "https://via.placeholder.com/600x400?text=Accomosuite+Blog";
...
            Temukan inspirasi perjalanan, tips akomodasi, dan berita terbaru
            eksklusif dari Accomosuite.
          </p>
        </div>
      </div>
...
              <div
                key={blog._id}
                className="bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden group flex flex-col h-full border border-gray-100"
              >
                {/* Image Container */}
